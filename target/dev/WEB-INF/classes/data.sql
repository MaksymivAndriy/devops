...
values ('Êè¿â', 50.4501, 30.5234),
       ('Õàðê³â', 49.9935, 36.2304),
       ('Äí³ïðî', 48.479512881488375, 35.00721554865378),
       ('Îäåñà', 46.4825, 30.7233),
       ('Çàïîð³ææÿ', 47.8228900, 35.1903100),
       ('Ëóãàíñüê', 48.5740, 39.3078),
       ('Äîíåöüê', 48.0159, 37.8028),
       ('Ëüâ³â', 49.8397, 24.0297),
       ('Ð³âíå', 50.6199, 26.2516);

insert into categories(name, url_logo, background_color, tag_background_color, tag_text_color)
values ('ñïîðòèâí³ ñåêö³¿', '/dev/static/images/categories/sport.svg', '#1890FF', '#1890FF', '#fff'),
       ('Òàíö³', '/dev/static/images/categories/dance.svg', '#531DAB', '#F9F0FF', '#531DAB'),
       ('ñòóä³¿ ðàííüîãî ðîçâèòêó', '/dev/static/images/categories/improvement.svg', '#73D13D',
        '#73D13D',
        '#fff'),
       ('ïðîãðàìóâàííÿ, ðîáîòîòåõí³êà, STEM', '/dev/static/images/categories/programming.svg', '#597EF7',
        '#597EF7',
        '#fff'),
       ('õóäîæí³ ñòóä³¿, ìèñòåöòâî, äèçàéí', '/dev/static/images/categories/art.svg', '#9254DE',
        '#9254DE',
        '#fff'),
       ('âîêàëüíà ñòóä³¿, ìóçèêà, ìóçè÷í³ ³íñòðóìåíòè', '/dev/static/images/categories/music.svg',
        '#FF7A45',
        '#FF7A45',
        '#fff'),
       ('àêòîðñüêà ìàéñòåðí³ñòü, òåàòð', '/dev/static/images/categories/theatre.svg', '#FF4D4F',
        '#FF4D4F',
        '#fff'),
       ('îñîáèñò³ñíèé ðîçâèòîê', '/dev/static/images/categories/self-improvement.svg', '#FADB14',
        '#FFF9D4',
        '#D46B08'),
       ('æóðíàë³ñòèêà, äèòÿ÷å òåëåáà÷åííÿ, ìîíòàæ â³äåî, âëîã³â',
        '/dev/static/images/categories/tv.svg',
        '#13C2C2',
        '#13C2C2', '#fff'),
       ('³íøå', '/dev/static/images/categories/other.svg', '#FFA940', '#FFA940', '#fff'),
       ('öåíòð ðîçâèòêó', '/dev/static/images/categories/center.svg', '#F759AB', '#F759AB', '#fff');
...
values ('center1', 'center1@gameil.com', 'center_address1', '+380000000001', 'some_links',
       ...
       ('Òâîð÷èé êðàé', 'center2@gameil.com', 'center_address2', '+380000000002', 'some_links',
        'center2_description',
...
values (6, 9, 'Äîâê³ëëÿ êð³çü ïðèçìó óêðà¿íñüêî¿ ìîâè 1', 'âóë. Óí³âåðñèòåòñüêà 52', '#', '#', 'dev/static/images/club/bg_2.png', '09:00-16:00', 50.4501,
        30.5234, 1, 1, 1, 2, 3,
       ...
       (7, 10, 'Äîâê³ëëÿ êð³çü ïðèçìó óêðà¿íñüêî¿ ìîâè 2', 'âóë. Óí³âåðñèòåòñüêà 52', '#', '#', 'dev/static/images/club/bg_1.jpg', '09:00-16:00', 49.988377487943026,
       ...
       (11, 16, 'Äîâê³ëëÿ êð³çü ïðèçìó óêðà¿íñüêî¿ ìîâè 3', 'âóë. Óí³âåðñèòåòñüêà 52', '#', '#', 'dev/static/images/club/bg_3.jpg', '09:00-16:00', 48.428760792192556,
       ...
       (6, 9, 'Äîâê³ëëÿ êð³çü ïðèçìó óêðà¿íñüêî¿ ìîâè 4', 'âóë. Óí³âåðñèòåòñüêà 52', '#', '#', 'dev/static/images/club/bg_4.jpg', '09:00-16:00', 46.492841277008196,
        30.746685697230422
       , 4, 4, 4, null, 2,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut ...', 5,true),
       (5, 10, 'Äîâê³ëëÿ êð³çü ïðèçìó óêðà¿íñüêî¿ ìîâè 5', 'âóë. Óí³âåðñèòåòñüêà 52', '#', '#', 'dev/static/images/club/bg_2.png', '09:00-16:00', 47.830640332833454,
        35.17341638260339, 5, 5, 5, null, 2,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut ...', 1,true),
       (5, 10, 'Äîâê³ëëÿ êð³çü ïðèçìó óêðà¿íñüêî¿ ìîâè 6', 'âóë. Óí³âåðñèòåòñüêà 52', '#', '#', 'dev/static/images/club/bg_2.png', '09:00-16:00', 48.535458078035944,
        39.28420328747561, 6, 6, 6, null, 3,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut ...', 3,true),
       (5, 10, 'Äîâê³ëëÿ êð³çü ïðèçìó óêðà¿íñüêî¿ ìîâè 7', 'âóë. Óí³âåðñèòåòñüêà 52', '#', '#', 'dev/static/images/club/bg_2.png', '09:00-16:00',48.0574323833658,
        37.776618035813655, 7, 7, 7, null, 2,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut ...', 1,true),
       (5, 10, 'Äîâê³ëëÿ êð³çü ïðèçìó óêðà¿íñüêî¿ ìîâè 8', 'âóë. Óí³âåðñèòåòñüêà 52', '#', '#', 'dev/static/images/club/bg_2.png', '09:00-16:00', 50.61060477065451,
        26.261240125246683, 8, 8, 8, null, 2,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut ...', 3.,true),
       (5, 10, 'Äîâê³ëëÿ êð³çü ïðèçìó óêðà¿íñüêî¿ ìîâè 9', 'âóë. Óí³âåðñèòåòñüêà 52', '#', '#', 'dev/static/images/club/bg_2.png', '09:00-16:00', 49.83483090260284,
        24.032436728841876, 9, 9, 9, 1, 2,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut ...', 5,true),
       (5, 10, 'Äîâê³ëëÿ êð³çü ïðèçìó óêðà¿íñüêî¿ ìîâè 10', 'âóë. Óí³âåðñèòåòñüêà 52', '#', '#', 'dev/static/images/club/bg_2.png', '09:00-16:00',
